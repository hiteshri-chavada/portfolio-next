    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-12 md:grid-cols-3 md:gap-10">
          ...
          <div className="self-start border-t border-border pt-8 md:border-t-0 md:border-l md:pt-0 md:pl-10">
            {details.map((detail) => (
              <div
                key={detail.label}
        ...
        <div className="mt-16 border-t border-border pt-10 text-center">
          <p
            className="font-signature text-6xl leading-none text-foreground sm:text-7xl"
            aria-hidden="true"
          >
            {settings.name}
          </p>
